...
const PrivacyPractice = () => {
    return (
        <div className="p-4">
            <Form>

                <p>
                    <b> NOTICE DESCRIBES HOW MEDICAL INFORMATION ABOUT YOU MAY BE USED AND DISCLOSED AND HOW YOU CAN GET ACCESS TO THIS INFORMATION. PLEASE REVIEW IT CAREFULLY.</b><br/>
                    <br/>
                    <b>WHO WILL FOLLOW THIS NOTICE OF PRIVACY PRACTICES</b><br/>
                    This Notice describes the privacy practices followed by the workforce members of the County of Los Angeles Department of Health Services, Mental Health, and Public Health, collectively referred to as the Health Agency (Agency). Workforce members include doctors, nurses, residents, therapists, case managers, students, volunteers, and other health care staff who help with your care at an Agency facility.<br/>
                    <br/>
                    <b>OUR PLEDGE REGARDING YOUR HEALTH INFORMATION</b><br/>
                    The law requires the Agency to:<br/><br/>

                    <FormGroup check inline>
                        <Input type="checkbox" id="ppHI1" ></Input>
                        <Label for="ppHI1">Keep your medical records and health information, also known as protected health information, private and secure.</Label>
                    </FormGroup>
                    <FormGroup check inline>
                        <Input type="checkbox" id="ppHI2" ></Input>
                        <Label for="ppHI2">Give you this Notice which explains your rights and our legal duties with respect to your health information.</Label>
                    </FormGroup>
                    <FormGroup check inline>
                        <Input type="checkbox" id="ppHI3"></Input>
                        <Label for="ppHI3">Tell you about our privacy practices and follow the terms of this Notice.</Label>
                    </FormGroup>
                    <FormGroup check inline>
                        <Input type="checkbox" id="ppHI4"></Input>
                        <Label for="ppHI4">Notify you if there has been a breach of the privacy of your health information.</Label>
                    </FormGroup>

                </p>
                <p>
                    <b>USES AND DISCLOSURES OF YOUR HEALTH INFORMATION</b><br/>

                    The following categories describe the different ways that we may use or disclose your health information without obtaining your authorization. For each category of use or disclosure, we will explain what we mean and try to give some examples. Not every use or disclosure in a category is listed. However, all of the ways we may use and disclose information falls within one of the categories.<br/>
                    <br/>
                    ...
                    Health Information Exchange: We, along with other health care providers in the Los Angeles area, may participate in one or more Health Information Exchanges (HIE). An HIE is a community-wide information system used by participating health care providers to share health information about you for treatment purposes. Should you require treatment from a health care provider that participates in one of these exchanges who does not have your medical records or health information, that health care provider can use the system to gather your health information in order to treat you.
                    For example, he or she may be able to get laboratory or other tests that have already been performed or find out about treatment(s) that you have already received.
                    We will include your health information in this system. If you would prefer your information not be shared with the HIE (opt-out) or have previously opted out of HIE participation and would like to share your information with the HIE (opt-in), please notify your registration staff or the business office at the facility where you obtain health care. The staff can help you change your preference using the HIE Change of Sharing Status form.

                    Hospital Directory: Our hospitals maintain a directory that lists patients admitted to the hospital so family and friends can call or visit you or so you can receive mail. If you do not object, we will include your name, location in the hospital, general condition (e.g., fair, stable, critical, etc.), and religious affiliation in the hospital directory. The directory Los Angeles County Health Agency Notice of Privacy Practices
                    ...
                    Research: Your health information may be provided to a researcher if you authorize the use of your health information for research purposes. In some situations, we may disclose your information to researchers preparing a research protocol or if our Institutional Review Board (IRB)
                    Committee determines that an authorization is not necessary. The IRB Committee is charged with ensuring the protection of human subjects in research. We also may provide limited health information about you (not including your name, address, or other direct identifiers) for research,
                    public health or health care operations, but only if the person or organization that receives the information signs an agreement to protect the information and not use it to identify you.

                    Judicial and Administrative Proceedings: If you are involved in a lawsuit or a dispute, we may disclose your health information in response to a court or administrative order. We may also disclose your health information in response to a subpoena, discovery request, or other legal
                    procedure by someone else involved in the dispute, but only if efforts have been made to tell you about the request (which may include written notice to you) or to obtain an order protecting the health information requested.
                    ...
                    Coroners, Medical Examiners, Funeral Directors and Information About Decedents: When required by law, your health information may be released to a coroner or medical examiner. This may be necessary, for example, to identify a deceased person or determine the cause of death.
                    We may also release limited health information to a funeral home. We may also give health information to family members or friends of a deceased person if they were involved in the person &rsquo;s care or paid for
                    ...
                    If you request a copy of your medical record, we may charge a fee for the costs of copying, mailing, or supplies associated with your request. If we deny your request, we will provide you with a written decision.

                    Right to Amend Your Health Information: If you feel that the health information contained in your medical record is incorrect or incomplete, you may ask us to correct or update the information. You have the right to request an amendment for as long as we keep the health information. To request an amendment, you must make your request,
                    in writing, to the facility where you obtain health care. You must state why you believe your health information is wrong or incomplete. In certain cases, we may deny your request for an amendment. If we deny your request, we will give you a written reason.

                    Right to Receive an Accounting of Disclosures of Health Information: You have the right to ask for an accounting of certain disclosures of your health information made by the Agency. This is a list of disclosures we made of your health information other than our own uses for treatment, payment and health care business.
                    ...
                    Right to Obtain a Paper Copy of Notice: You have the right to receive a paper copy of this Notice at any time, even if you have already received a copy or have agreed to receive this Notice electronically. You may obtain a paper copy of this Notice from the facility where you obtain health care.
                    An electronic copy of this Notice is also available on our websites: dhs.lacounty.gov, dmh.lacounty.gov or publichealth.lacounty.gov.
                </p>

                <p>
                    <b>HOW TO FILE A COMPLAINT</b>
                    ...
                    Privacy Officer
                    313 N. Figueroa Street, Room 703 Los Angeles, CA 90012
                    (800) 711-5366
                    ...
                    County of Los Angeles Department of Mental Health Director of Patients’ Rights 550 South Vermont Avenue
                    Los Angeles, CA 90020 (800) 700-9996
                ...
                <div className="form-body">
                    ...
                    <Row>
                        ...
                        <Col md="3">
                            <FormGroup check inline>
                                <Input type="text" id="cftCopyDate" defaultValue="Date Here"/>
                                <Input type="text" id="cftCopyInit" defaultValue="Initials Here"/>
                            </FormGroup>
                        </Col>
                    </Row>
                </div>
